...
export class SessionManager {
  ...
  createSession(saved?: PersistedPlayer): GameSession { const session = new GameSession(randomUUID(), this.wallets, this.auction, saved); this.sessions.set(session.id, session); return session; }
